...
import postTwetch from "../../services/twetch/post-twetch";
...
export default function Features() {
  ...
  const handlePayFeature = async () => {
    const featurePost = `/pay @76407 $${amount} to build no-code website builder`;
    postTwetch(featurePost, () => alert("Thank you!"));
  };
          ...
          <div className="px-4 lg:px-0 grid mt-4 lg:mt-7 gap-4 grid-cols-12">
            <div className="col-span-12 lg:col-span-6 xl:col-span-4 bg-gray-100 dark:bg-gray-600 rounded-lg p-4 w-full relative flex flex-col">
              ...
              <p className="text-sm text-gray-900 opacity-70 dark:text-white mt-2">
                Create your own Twetch client in a few clicks.
              </p>
              <div className="grow" />
              <div className="mt-3">
            ...
            {/* <div className="col-span-12 lg:col-span-6 xl:col-span-4 bg-gray-100 dark:bg-gray-600 rounded-lg p-4 w-full relative flex flex-col">
              ...
              <div className="mt-4">
                <div className="flex">
                  ...
                  <button className="py-1 px-4 border-none rounded-md text-white bg-gradient-to-tr from-blue-400 to-blue-500 cursor-pointer flex items-center text-center justify-center disabled:opacity-50 transition duration-500 transform hover:-translate-y-1">
                    Pay
                  </button>
                </div>
              </div>
