...
import {
  ...
  userProfileLatestFeedQuery,
  userProfileLatestFeedPaginationQuery,
} from "../../../services";
...
export default function UserPageLatest({ userProfileCard }) {
  ...
  useEffect(() => {
    userProfileLatestFeedQuery(id).then((data) => {
  ...
  const fetchMore = async () => {
    cursor &&
      userProfileLatestFeedPaginationQuery(id, cursor).then((data) => {
